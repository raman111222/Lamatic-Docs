...
const permanentRedirects = [
  ...
  [
    "/docs/apps/data-sources",
    "https://lamatic.ai/docs/integrations#data-sources",
  ],
  ...
  [
    "/docs/langfuse-integration",
    "https://www.lamatic.ai/docs/reports/langfuse-integration",
  ],
  ...
  [
    "/docs/context/Method-1:VectorDB/adding-data",
    "/docs/context/vectordb/adding-data",
  ],
  ...
  ['/docs/workflows/Low Code "Builder', "/docs/node/execute-flow"],
  ...
  [
    '/docs/studio/Project/Settings/Developer "Integrations',
    "/docs/studio/project",
  ],
...
const rewrites = [
  ...
  [
    "/:path((?!docs|blog|guides|_next|public|assets|images|api|robots.txt|sitemap-0.xml).*)",
